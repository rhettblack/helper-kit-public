...
imgui.OnInitialize(function()
    ...
    icon = imgui.GetIO().Fonts:AddFontFromFileTTF('moonloader/resource/lunahz/fonts/fa-solid-900.ttf', 14.0, config, iconRanges)
end)
...
local newFrame = imgui.OnFrame(
    ...
    function(self)
        ...
        imgui.SetWindowPosVec2(imgui.ImVec2(resX - 10 - winSize.x, resY/2))

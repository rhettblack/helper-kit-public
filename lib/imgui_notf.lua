...
function main()
	while true do
		...
		print("imgui_notf processing...") -- Debug print
	end
end
	...
	for k, v in ipairs(message) do
		...
		if count < 3 then
			...
			if v.active then
				...
				imgui_notf.SetNextWindowPos(notfList.pos, imgui_notf.Cond.FirstUseEver, imgui_notf.ImVec2(0.0, 0.0))
				...
				imgui_notf.Begin(u8'##msg' .. k, true, imgui_notf.WindowFlags.NoCollapse + imgui_notf.WindowFlags.NoResize + imgui_notf.WindowFlags.NoScrollbar + imgui_notf.WindowFlags.NoMove + imgui_notf.WindowFlags.NoTitleBar)
...
function EXPORTS.addNotification(text, time)
	...
	print("Rendering notification...") -- Debug print
end
